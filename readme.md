...
```
<script src="https://cdn.jsdelivr.net/npm/patchpack@0.4.1/browser/patchpack.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/patchpack@0.4.1/browser/patchpack.js"></script>
```
