...
```
<script src="https://cdn.jsdelivr.net/npm/patchpack@0.3.11/browser/patchpack.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/patchpack@0.3.11/browser/patchpack.js"></script>
```
