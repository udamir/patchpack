...
```
<script src="https://cdn.jsdelivr.net/npm/patchpack@0.2.2/browser/patchpack.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/patchpack@0.2.2/browser/patchpack.js"></script>
```
